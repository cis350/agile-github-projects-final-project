    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <div className="p-8 bg-white shadow-sm rounded-xl w-96">
        ...
        <div className="mb-4 relative">
          ...
          <a href="#" className="text-xs flex justify-end mt-2 text-gray-800">Forgot password?</a>
        </div>
        ...
        {
        visibleInvalidFields && (<label htmlFor="invalidfields" className="block text-sm font-medium text-gray-700">
            {errorMessage}
        </label>)}
      </div>
    </div>
